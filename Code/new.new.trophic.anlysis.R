...
model1_last_period_pred <- HLCor(ln.pred ~ structure + bac.density_log  + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density, adjMatrix = as.matrix(adj_matrix))
#summary(model1_last_period_pred, corr = FALSE)

model2_last_period_pred <- HLCor(ln.pred ~ bac.density_log  + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density, adjMatrix = as.matrix(adj_matrix))
#summary(model2_last_period_pred, corr = FALSE)

model3_last_period_pred <- HLCor(ln.pred ~ structure + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density, adjMatrix = as.matrix(adj_matrix))
#summary(model3_last_period_pred, corr = FALSE)

model4_last_period_pred <- HLCor(ln.pred ~ 1 + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density, adjMatrix = as.matrix(adj_matrix))
...
dog1<-"density ~ structure + bac.density_log  + (1|rep) + adjacency(1|bottle.number)"
dog2<-"density ~ bac.density_log  + (1|rep) + adjacency(1|bottle.number)"
dog3<-"density ~ structure + (1|rep) + adjacency(1|bottle.number)"
...
model1_all_period_prey <- HLCor(ln.prey ~ structure + bac.density_log  + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density, adjMatrix = as.matrix(adj_matrix))
...
model3_all_period_prey <- HLCor(ln.prey ~ structure + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density, adjMatrix = as.matrix(adj_matrix))
...
model1_first_period_pred <- HLCor(ln.pred ~ structure + bac.density_log  + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model1_last_period_pred, corr = FALSE)

model2_first_period_pred <- HLCor(ln.pred ~ bac.density_log  + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model2_last_period_pred, corr = FALSE)

model3_first_period_pred <- HLCor(ln.pred ~ structure + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model3_last_period_pred, corr = FALSE)

model4_first_period_pred <- HLCor(ln.pred ~ 1 + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model4_last_period_pred, corr = FALSE)
...
mod3_aic<-extractAIC(model3_first_period_pred)
mod3_r2<-pseudoR2(model3_first_period_pred, nullform = ~1)

mod4_aic<-extractAIC(model4_first_period_pred)
mod4_r2<-pseudoR2(model4_first_period_pred, nullform = ~1)
...
model1_all_period_prey <- HLCor(ln.prey ~ structure + bac.density_log  + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model1_all_period_prey, corr = FALSE)
...
model3_all_period_prey <- HLCor(ln.prey ~ structure + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model3_all_period_prey, corr = FALSE)
...
model1_two_period_pred <- HLCor(ln.pred ~ structure + bac.density_log  + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model1_last_period_pred, corr = FALSE)

model2_two_period_pred <- HLCor(ln.pred ~ bac.density_log  + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model2_last_period_pred, corr = FALSE)

model3_two_period_pred <- HLCor(ln.pred ~ structure + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model3_last_period_pred, corr = FALSE)
...
mod3_aic<-extractAIC(model3_two_period_pred)
mod3_r2<-pseudoR2(model3_two_period_pred, nullform = ~1)

mod4_aic<-extractAIC(model4_two_period_pred)
mod4_r2<-pseudoR2(model4_two_period_pred, nullform = ~1)
...
model1_two_period_prey <- HLCor(ln.prey ~ structure + bac.density_log  + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model1_all_period_prey, corr = FALSE)
...
model3_two_period_prey <- HLCor(ln.prey ~ structure + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model3_all_period_prey, corr = FALSE)
...
model1_three_period_pred <- HLCor(ln.pred ~ structure + bac.density_log  + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model1_last_period_pred, corr = FALSE)
...
model3_three_period_pred <- HLCor(ln.pred ~ structure + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model3_last_period_pred, corr = FALSE)
...
model1_three_period_prey <- HLCor(ln.prey ~ structure + bac.density_log  + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model1_all_period_prey, corr = FALSE)
...
model3_three_period_prey <- HLCor(ln.prey ~ structure + (1|rep) + adjacency(1|bottle.number), family = gaussian, data = env_density_pred, adjMatrix = as.matrix(adj_matrix))
#summary(model3_all_period_prey, corr = FALSE)
