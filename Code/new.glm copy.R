...
########################################################################
#1B) Prey
y <- cbind(prop_pa_rep_connect$prey.occupany, prop_pa_rep_connect$n)
...
########################################################################
#1B) Predator
y <- cbind(prop_pa_rep_connect$pred.occupany, prop_pa_rep_connect$n)
...
dog0<-glm(y~structure, family=binomial(link = "logit"), data=prop_pa_rep_connect)
dogg<-glht(dog0, linfct=mcp(structure = "Tukey"))
summary(dogg)
...
bb<-Ext_col_data_glm%>%
  ...
  theme(axis.line = element_line(colour = "black"),panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.border = element_blank(),panel.background = element_blank())+theme(legend.position = c(0.9, 0.9))
...
########################################################################
#Prey
y <- cbind(Ext_col_data_glm$colonization_sum_prey, Ext_col_data_glm$colonization_potenital_prey)
...
########################################################################
# Predator
y <- cbind(Ext_col_data_glm$colonization_sum_pred, Ext_col_data_glm$colonization_potenital_pred)
...
########################################################################
#1B) Prey
y <- cbind(Ext_col_data_glm$extinction_sum_prey, Ext_col_data_glm$extinction_potenital_prey)
...
########################################################################
#2B) Predator
y <- cbind(Ext_col_data_glm$extinction_sum_pred, Ext_col_data_glm$extinction_potenital_pred)
...
bbb<-Ext_col_data_glm%>%
  ...
  theme(axis.line = element_line(colour = "black"),panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.border = element_blank(),panel.background = element_blank())+theme(legend.position = c(0.85, 0.85),legend.background = element_blank(),
